...
CREATE OR REPLACE TRIGGER "handle_updated_at" BEFORE UPDATE ON "public"."project_contacts" FOR EACH ROW EXECUTE FUNCTION "public"."handle_updated_at"();
...
CREATE POLICY "Office and Owner can delete project_contacts" ON "public"."project_contacts" FOR DELETE TO "authenticated" USING (((( SELECT "user_roles"."role"
   FROM "public"."user_roles"
  WHERE ("user_roles"."user_id" = "auth"."uid"())) = 'office'::"public"."user_role") OR (( SELECT "user_roles"."role"
   FROM "public"."user_roles"
  WHERE ("user_roles"."user_id" = "auth"."uid"())) = 'owner'::"public"."user_role")));



CREATE POLICY "Office and Owner can insert project_contacts" ON "public"."project_contacts" FOR INSERT TO "authenticated" WITH CHECK (((( SELECT "user_roles"."role"
   FROM "public"."user_roles"
  WHERE ("user_roles"."user_id" = "auth"."uid"())) = 'office'::"public"."user_role") OR (( SELECT "user_roles"."role"
   FROM "public"."user_roles"
  WHERE ("user_roles"."user_id" = "auth"."uid"())) = 'owner'::"public"."user_role")));
...
CREATE POLICY "Office and Owner can update project_contacts" ON "public"."project_contacts" FOR UPDATE TO "authenticated" USING (((( SELECT "user_roles"."role"
   FROM "public"."user_roles"
  WHERE ("user_roles"."user_id" = "auth"."uid"())) = 'office'::"public"."user_role") OR (( SELECT "user_roles"."role"
   FROM "public"."user_roles"
  WHERE ("user_roles"."user_id" = "auth"."uid"())) = 'owner'::"public"."user_role")));
...
CREATE POLICY "Teamleads can read project_contacts" ON "public"."project_contacts" FOR SELECT TO "authenticated" USING (((( SELECT "user_roles"."role"
   FROM "public"."user_roles"
  WHERE ("user_roles"."user_id" = "auth"."uid"())) = 'teamlead'::"public"."user_role") OR (( SELECT "user_roles"."role"
   FROM "public"."user_roles"
  WHERE ("user_roles"."user_id" = "auth"."uid"())) = 'office'::"public"."user_role") OR (( SELECT "user_roles"."role"
   FROM "public"."user_roles"
  WHERE ("user_roles"."user_id" = "auth"."uid"())) = 'owner'::"public"."user_role")));
